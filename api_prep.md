...
* **nifti_image (str or None), default=None**: If the data type is NIFTI, specify the name of the NIFTI image file, including the extension. E.g. `nifti_image='image.nii.gz`;
