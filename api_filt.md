...
* **padding_type (str) {'constant', 'nearest', 'wrap', 'reflect'}**: Different strategies for handling boundary voxels. For more detailed information consult the [Filtering](tabs/filtering.md);
